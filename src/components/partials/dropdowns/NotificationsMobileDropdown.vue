            ...
            <a class="notification-item">
              <div class="img-left">
                <img
                  class="user-photo"
                  alt=""
                  src="/images/avatars/svg/solarspeed-4.svg"
            ...
            <a class="notification-item">
              <div class="img-left">
                <img
                  class="user-photo"
                  alt=""
                  src="/images/avatars/svg/solarspeed-2.svg"
                  @error.once="(event) => onceImageErrored(event, '150x150')"
                />
              </div>
              <div class="user-content">
            ...
            <a class="notification-item">
              <div class="img-left">
                <img
                  class="user-photo"
                  alt=""
                  src="/images/avatars/svg/solarspeed-5.svg"
                  @error.once="(event) => onceImageErrored(event, '150x150')"
                />
              </div>
              <div class="user-content">
            ...
            <a class="notification-item">
              <div class="img-left">
                <img
                  class="user-photo"
                  alt=""
                  src="/images/avatars/svg/solarspeed-9.svg"
                  @error.once="(event) => onceImageErrored(event, '150x150')"
                />
              </div>
              <div class="user-content">
