  ...
  <div class="section">
    <div class="container">
      ...
      <div class="section-title has-text-centered">
        ...
        <h4>solarspeed has been carefully handcrafted.</h4>
      </div>
      ...
      <div class="columns is-vcentered side-feature">
        ...
        <div class="column is-5">
          ...
          <p class="section-feature-description is-centered-tablet-portrait">
            solarspeed's UI has been carefully thought and designed, and is simply one of
            the best you'll find on the market. It's visual power and its modularity will
            let you build great apps seamlessly.
          </p>
        </div>
      </div>
      <!-- Feature -->
      <div class="columns is-vcentered side-feature">
        ...
        <div class="column is-5 is-offset-1">
          ...
          <p class="section-feature-description is-centered-tablet-portrait">
            solarspeed ships with a lot of svg illustrations representing various elements
      ...
      <div class="columns is-vcentered side-feature">
        ...
        <div class="column is-5">
          ...
          <p class="section-feature-description is-centered-tablet-portrait">
            solarspeed ships with it's own component library based on the Bulma.io CSS
      ...
      <div class="cta-block no-border">
        <div class="head-text">
          ...
          <p>Check out the solarspeed documentation</p>
        </div>
        <div class="head-action">
          <div class="buttons">
            <VButton
              ...
              rounded
              elevated
              href="https://docs.cssninja.io/solarspeed"
            >
              Read the Docs
            </VButton>
            <a
