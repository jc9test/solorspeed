<template>
  <footer class="solarspeed-footer">
    <div class="container">
      <div class="footer-head">
        <div class="head-text">
          <h3>Ready to get started?</h3>
          <p>Get your solarspeed copy now</p>
        </div>
        <div class="head-action">
          <div class="buttons">
            <a
              href="https://themeforest.net/item/solarspeed-vuejs-3-admin-and-webapp-ui-kit/31053035"
        ...
        <div class="column is-4">
          <div class="p-t-10 p-b-10">
            ...
            <div class="footer-description p-t-10 p-b-10">
              solarspeed is built for developers and designers. It's modular approach lets
              you create awesome navbars with incredible layouts and elements.
            </div>
          </div>
          <div>
            <span class="moto">
          ...
          <div class="columns is-flex-tablet-p">
            ...
            <div class="column">
              <ul class="footer-column">
                <li class="column-header">solarspeed</li>
