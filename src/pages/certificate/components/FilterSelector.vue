...
function initFormItem() {
  ...
  formReferences.keypairname.value = ''
  formReferences.commonName.value = ''
  formReferences.issuerCommonName.value = ''
  formReferences.sanDns.value = ''
  formReferences.validityStart.value = ''
  formReferences.validityEnd.value = ''
  formReferences.emailAddress.value = ''
...
<template>
  <div class="filter-form-originPolicy">
    ...
    <VModal
      :open="isFilterOpen"
      :title="`Certificates ${t('filter.filter')}`"
      size="big"
      actions="right"
