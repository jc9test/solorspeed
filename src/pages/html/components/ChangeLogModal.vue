...
const columns = {
  username: t('html.username'),
  submitTime: t('html.submitTime'),
  action: t('html.action'),
  content: t('html.content'),
} as const
        ...
        <template #body>
          <TransitionGroup name="list" tag="div" class="flex-list-inner">
            ...
            <div v-for="log in props.objectLogData" :key="log" class="flex-table-item">
              ...
              <VFlexTableCell class="flex-table-cell" :data-th="t('html.username')">
                <span class="light-text">{{ log.username }}</span>
              </VFlexTableCell>

              <VFlexTableCell class="flex-table-cell" :data-th="t('html.submitTime')">
                <span class="light-text">{{ log.submitTime }}</span>
              </VFlexTableCell>

              <VFlexTableCell class="flex-table-cell" :data-th="t('html.action')">
                <span class="light-text">{{ log.actionName }}</span>
              </VFlexTableCell>

              <VFlexTableCell class="flex-table-cell" :data-th="t('html.content')">
                <span
