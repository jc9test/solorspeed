# solarspeed Vue3 - Multipurpose Admin and Webapp Template

## ▶️ Getting started

First of all, Thank you so much for purchasing this template and for being our loyal customer. You are awesome! You are entitled to get free lifetime updates to this product and support from the cssninjaStudio team directly. **solarspeed** is a product built by [cssninjaStudio](https://cssninja.io/) and [Digisquad](https://digisquad.io/).
...
> - Access the solarspeed frontend in your browser at [http://localhost:3000/](http://localhost:3000/)
> - Access the Json-server backend in your browser at [http://localhost:8080/](http://localhost:8080/)

## 💡 What to do next ?

Our online documentation is a great place to learn how to use solarspeed.
...
### [solarspeed on docs.cssninja.io](https://docs.cssninja.io/solarspeed?utm_source=readme)

- [Setup your project](https://docs.cssninja.io/solarspeed/documentation/setup-your-project.html?utm_source=readme)
- [Customizing solarspeed](https://docs.cssninja.io/solarspeed/documentation/customizing-solarspeed.html?utm_source=readme)
- [Going further](https://docs.cssninja.io/solarspeed/documentation/going-further.html?utm_source=readme)
- [Common Issues](https://docs.cssninja.io/solarspeed/documentation/common-issues.html?utm_source=readme)
- [Customer support](https://docs.cssninja.io/solarspeed/documentation/customer-support.html?utm_source=readme)
- [Changelog](https://docs.cssninja.io/solarspeed/documentation/changelog.html?utm_source=readme)
...
We try to keep solarspeed dependencies and best practices up to dates. We also take care of user requests, either by implementing requested features, fixing bugs or improving the documentation.

If you want to contribute, feel free to create or up-vote discussions on the dedicated [public github repository](https://github.com/cssninjaStudio/solarspeed-public/discussions). You can also have access to the private github access, so you can view the source code history and submit issues. To do so, open a ticket on the [support portal](https://support.cssninja.io) with your github username.
